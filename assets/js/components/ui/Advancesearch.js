const temp = `
    <section class="h-screen w-full absolute shadow-box hidden">
        <div class="bg-gray-200 w-9/12 mt-20 p-3 zi-1 rounded-lg mx-auto absolute animate__animated animate__fadeInUp left-0 right-0">
            <span class="text-lg w-full block font-bold">Search By : </span>
            <a v-for="search in searchBy" class="btn btn-outline-primary mt-1 mx-1 rounded-full" v-html="setLabel(search.icon, search.label)">
            </a>
        </div>
